...
class MRBT_Backtester(object):
    ...
    def run_strategy(self, SMA, threshold_std, roll = 100, r = 0.0225, halfKC = True):
...
if __name__ == '__main__':
    mrbt = MRBT_Backtester('AUD_JPY', '2015-12-8', '2016-12-10')
    print(mrbt.run_strategy(SMA=[x for x in range(0,220,20)],halfKC=True))
